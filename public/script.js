...
async function next() {
    ...
    if (currentitem.localisation) {
        document.querySelector('#localisation').innerHTML = `<a target="_blank" href="https://www.google.com/maps/place/${currentitem.localisation}"><i class="bi bi-geo-alt"></i><span>${currentitem.localisation}</span></a> `
    }
